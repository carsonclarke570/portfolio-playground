...
export const InstancedGrassMaterial = shaderMaterial({
    ...
    /*glsl*/`
        ...
        void main() {
            ...
            vUv = uv;
            vNormal = normalMatrix * vec3(0.0, 1.0, 0.0);
            vPosition = worldPos.rgb;
            vNodePosition = (instanceMatrix * vec4(vec3(0.0), 1.0)).rgb;
    ...
    /*glsl*/`
        ...
        void main() {
            float noiseLevel = fbm(vNodePosition.xz / 8.0);
